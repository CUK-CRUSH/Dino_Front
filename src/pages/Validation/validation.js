    ...
    return (
        <Layout>
            <div className="w-[390px] h-[844px] relative bg-white">
                ...
                <input type="text" onChange={e => onChange(e)} placeholder={"user name"} className=" left-[57px] w-[275px] top-[409px] absolute text-center text-zinc-300 text-xl font-medium font-['Noto Sans'] border-none outline-none ">
                </input>
