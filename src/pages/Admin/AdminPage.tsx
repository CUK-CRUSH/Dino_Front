...
const calculateOptionsModalPosition = (e: { target: any; }) => {
      ...
      >
        {selectedImage ? (
          ...
          />
            ...
            <>
                <div className={"pt-[58px] pl-[181px]"  }>
  ...
  <div className={"w-[22px] h-30 left-[352px] top-[15px] absolute"}>
  <button
...
>
  Edit Profile
      ...
      {/* <div style={{ display: "flex", justifyContent: "flex-end" }}>
        ...
        <div className=" ml-[70px] w-[250px] mr-[70px] flex items-center flex-col z-40">
      ...
      <button className="w-[169px] h-[169px] rounded-[13px] border-2 border-zinc-300 font-light text-zinc-300 text-4xl ml-[16px] mt-[42px]">
        +
