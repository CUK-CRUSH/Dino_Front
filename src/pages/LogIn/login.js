    ...
    <Layout>
      <div className="w-[390px] h-[844px] relative bg-white">
        <svg
          ...
          className="left-[37px] top-[622px] z-30 absolute"
          width="11"
          height="18"
          viewBox="0 0 11 18"
          fill="none"
        ...
        <div className="w-[284px] h-[49px] left-[15px] top-[614px] absolute">
          ...
          <div className="left-[40px] top-[7px] absolute text-white text-[15px] font-medium font-['Noto Sans']">
        ...
        <div className="w-[360px] h-[58px] left-[15px] top-[671px] absolute">
          ...
          <button onClick={handleLogin}>
            <div className="w-[214px] h-[23px] left-[73px] top-[18px] absolute">
              <img
                className="z-30 left-[88px] top-[690px]"
                src={googlelogo}
                alt={googlelogo}
              ></img>
        ...
        <div className="w-[360px] h-[58px] left-[15px] top-[743px] absolute">
          ...
          <div className="w-[235px] h-[23px] left-[62px] top-[18px] absolute">
            <img
              className="z-20 left-[77px] top-[762px]"
              src={facebook}
              alt={facebook}
            ></img>
            <div className="left-[34px] top-0 absolute text-center text-black text-[17px] font-semibold font-['Noto Sans']">
              <Link to={"/login/validation"}>Continue with Facebook</Link>
            </div>
        ...
        <svg
          ...
          width="64"
          height="64"
          className="left-[163px] top-[162px] absolute"
          viewBox="0 0 64 64"
          fill="none"
        >
          <path
        ...
        <img
          className="w-[179px] h-[55px] left-[106px] top-[248px] absolute"
          src={mylist2}
          alt={mylist2}
        />
      </div>
