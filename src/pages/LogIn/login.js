    ...
    return (
        <Layout>
            <div className="w-[390px] h-[844px] relative bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="left-[37px] top-[622px] z-30 absolute" width="11" height="18" viewBox="0 0 11 18" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M7.07136 0.81856C7.07145 0.638706 7.01462 0.463833 6.90967 0.320993C6.80472 0.178152 6.65749 0.0753055 6.49075 0.0283611C6.32402 -0.0185833 6.14708 -0.00700893 5.98731 0.0612939C5.82753 0.129597 5.69381 0.250821 5.60685 0.406216L0.107085 10.2239C0.0374106 10.3483 0.000473822 10.4896 4.52837e-06 10.6335C-0.000464765 10.7775 0.0355498 10.919 0.104412 11.0438C0.173275 11.1687 0.272547 11.2723 0.392205 11.3444C0.511863 11.4165 0.64767 11.4545 0.785914 11.4544H3.92864V17.1814C3.92855 17.3613 3.98538 17.5362 4.09033 17.679C4.19529 17.8218 4.34252 17.9247 4.50925 17.9716C4.67598 18.0186 4.85292 18.007 5.0127 17.9387C5.17247 17.8704 5.30619 17.7492 5.39315 17.5938L10.8929 7.77606C10.9626 7.65172 10.9995 7.51044 11 7.36649C11.0005 7.22254 10.9644 7.081 10.8956 6.95617C10.8267 6.83135 10.7275 6.72766 10.6078 6.65556C10.4881 6.58347 10.3523 6.54553 10.2141 6.54557H7.07136V0.81856Z" fill="white"/>
                </svg>
                <div className="w-[284px] h-[49px] left-[15px] top-[614px] absolute">
                    <div className="w-[284px] h-[35px] left-0 top-0 absolute bg-black rounded-[30px]" />
                    <div className="left-[40px] top-[7px] absolute text-white text-[15px] font-medium font-['Noto Sans']">Log in with your social account</div>
                </div>
                <div className="w-[360px] h-[58px] left-[15px] top-[671px] absolute">
                    ...
                    <Link to={"http://34.64.96.158:8080/login/google"}><div className="w-[214px] h-[23px] left-[73px] top-[18px] absolute">
