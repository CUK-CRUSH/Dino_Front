...
export const AddPlayList = () => {
  ...
  <Link to="13" style={{ textDecoration: 'none' }}>
    <button className="w-[150px] h-[150px] rounded-[13px] border-2 border-zinc-300 font-light text-zinc-300 text-4xl ">
      ...
      <img className="mx-auto mt-[47.5px] mb-[71.5px] w-[55px] h-[55px]" src={plus} alt="Plus Icon" />

      <div className="absolute bottom-0 left-0 right-0 text-center text-zinc-300 text-[13px] font-medium font-['Noto Sans']">
        New PlayList
      </div>
