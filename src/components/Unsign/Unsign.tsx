...
const Unsign = () => {
    ...
    return (
        <div className="h-screen bg-gray-100 font-pretendard">
            <form onSubmit={handleSubmit} className="bg-gray-100 p-4">
                ...
                <button style={{backgroundColor: buttonColor, borderRadius: '0.5rem', height: '6vh', width: '100%'}} type="submit" className="px-4 py-2 rounded text-white">
                    계정 삭제
                </button>
            </form>
